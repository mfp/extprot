...
is serialized as this 20-byte message (output from `hexdump -C`)

    00000000  01 12 02 00 02 03 0d 4a  2e 52 2e 52 20 54 6f 6c  |.......J.R.R Tol|
    00000010  6b 69 65 6e                                       |kien|
    00000014
